...
public class UploadImagesX {
    ...
    // Properties loadPPTfile = new Properties();
   LoadPPTfile loadPPTfile = new LoadPPTfile();

    public boolean ploadOtherDocument(UploadedFile file, String account) throws Exception {
    ...
    public boolean uploadImg(UploadedFile file, String account) throws Exception {
        ...
        try {
            ...
            String pst_location = loadPPTfile.ImagePath();
            String pst_url_location =loadPPTfile.SitePath();
