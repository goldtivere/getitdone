...
public class ThreadRunner implements Runnable {
    ...
    public void updateSmsTable(String statusCode, String description,String phonenumber) {
        ...
        try {
            ...
            String updateSmsTable = "update tbtempregistration set verified=?,statuscode=?,statusdescription=?,datesent=? where phonenumber=?";
    ...
    public void runValue(List<MessageModel> model) throws NullPointerException, IOException {
        ...
        try {
            ...
            for (MessageModel messageModel : model) {
                ...
                //doTransaction();
                updateSmsTable(responseCod, val, messageModel.getPhonenumber());
